...
public class SitiosServicio extends Activity implements LocationListener {
	...
	// Private classes
	// ***************************************
	private class DownloadStatesTask extends AsyncTask<Void, Void, SitioMovilDTO[]> {
		...
		@Override
		protected SitioMovilDTO[] doInBackground(Void... params) {
		...
		@Override
		protected void onPostExecute(SitioMovilDTO[] sitios) {
