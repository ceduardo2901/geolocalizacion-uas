...
public class UsuarioDAO implements IUsuarioDAO {
	...
	public boolean existeUsuario(String mail, int activo) throws SQLException {
		...
		try {
			...
			if (ConexionJDBCUtil.getConexion() != null) {
				logger.debug("cierro de conexion");
	...
	public void aprobarSolicitudContacto(SolicitudContactoDTO solicitud)
		...
		ps = ConexionJDBCUtil.getConexion()
				.prepareStatement(sqlAprobarContacto);
		...
		try {
			...
			while (rs.next()) {
				...
				if (geom != null) {
					...
					posicion.setFechaActualizacion(rs
							.getTimestamp("usu_ubicacion_fecha"));
